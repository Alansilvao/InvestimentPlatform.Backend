...
(
	COD_PORTFOLIO INT IDENTITY NOT NULL,
	COD_CONTA INT NOT NULL,
	COD_ATIVO INT NOT NULL,
	NOM_SIMBOLO VARCHAR(10) NOT NULL,	
	VAL_QUANTIDADE INT NOT NULL,
	VAL_PRECO_MEDIO DECIMAL(18,2) NOT NULL,
	VAL_AQUISICAO DECIMAL(18,2) NOT NULL,
	VAL_ATUAL DECIMAL(18,2) NOT NULL,
	VAL_RENTABILIDADE DECIMAL(18,2) NOT NULL,
	PCT_RENTABILIDADE DECIMAL(18,2) NOT NULL,
	DAT_INC DATETIME2 NOT NULL,
	DAT_ALT DATETIME2 NOT NULL,	
	CONSTRAINT PK_PORTFOLIO PRIMARY KEY (COD_PORTFOLIO),
	CONSTRAINT FK_PORTFOLIO_CONTA FOREIGN KEY (COD_CONTA) REFERENCES CONTA (COD_CONTA),
	CONSTRAINT FK_PORTFOLIO_ATIVO FOREIGN KEY (COD_ATIVO) REFERENCES ATIVO (COD_ATIVO),
); 
